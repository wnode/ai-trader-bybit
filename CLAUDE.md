...
- `analyst.py` — integração com LLMs (Gemini, Claude, GPT). Prompt com regras de trading
...
- `monitor.py` — exibe conta, posição aberta e histórico filtrado por trades do bot
